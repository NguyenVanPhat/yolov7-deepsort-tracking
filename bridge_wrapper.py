                    ...
                    for object_past in list_object_in_frame_past:
                        for object_current in list_object_in_frame_current:
                            if object_current[0] == object_past[0]:
                                thickness = round(((object_current[4] + object_current[5])/47))
                                if thickness == 0: thickness = 1
                                cv2.line(frame, (int(object_past[1]), int(object_past[2])), (int(object_current[1]), int(object_current[2])), object_current[3], thickness)
